...
def setup():
    ...
    #w1
    l.append(mapwalls(Vector(tile_size * random.randint(2,25), tile_size * random.randint(2, 38)), Vector(tile_size * 9, tile_size)))
    #w2
    l.append(mapwalls(Vector(tile_size * random.randint(2,25), tile_size * random.randint(2, 38)), Vector(tile_size, tile_size * 8)))
    l.append(mapwalls(Vector(tile_size * random.randint(2,25), tile_size * random.randint(2, 38)), Vector(tile_size, tile_size * 9)))
    l.append(mapwalls(Vector(tile_size * random.randint(2,25), tile_size * random.randint(2, 38)), Vector(tile_size, tile_size * 9)))
    l.append(mapwalls(Vector(tile_size * random.randint(2,25), tile_size * random.randint(2, 38)), Vector(tile_size, tile_size * 9)))
    l.append(mapwalls(Vector(tile_size * random.randint(2,25), tile_size * random.randint(2, 38)), Vector(tile_size, tile_size * 9)))
    l.append(mapwalls(Vector(tile_size * random.randint(2,25), tile_size * random.randint(2, 38)), Vector(tile_size, tile_size * 9)))
    l.append(mapwalls(Vector(tile_size * random.randint(2,25), tile_size * random.randint(2, 38)), Vector(tile_size * 5, tile_size)))
    #w3
    l.append(mapwalls(Vector(tile_size * random.randint(2,25), tile_size * random.randint(2, 38)), Vector(tile_size, tile_size * 4)))
    #w4
    l.append(mapwalls(Vector(tile_size * random.randint(2,25), tile_size * random.randint(2, 38)), Vector(tile_size * 8, tile_size)))
    #w5
    l.append(mapwalls(Vector(tile_size * random.randint(2,25), tile_size * random.randint(2, 38)), Vector(tile_size, tile_size * 8)))
    #w6
    l.append(mapwalls(Vector(tile_size * random.randint(2,25), tile_size * random.randint(2, 38)), Vector(tile_size * 3, tile_size)))
    l.append(mapwalls(Vector(tile_size * random.randint(2,25), tile_size * random.randint(2, 38)), Vector(tile_size * 3, tile_size)))
    #w7
    l.append(mapwalls(Vector(tile_size * random.randint(2,25), tile_size * random.randint(2, 38)), Vector(tile_size * 1, tile_size * 2)))
    l.append(mapwalls(Vector(tile_size * random.randint(2,25), tile_size * random.randint(2, 38)), Vector(tile_size * 1, tile_size * 2)))
    #w8
    l.append(mapwalls(Vector(tile_size * random.randint(2,25), tile_size * random.randint(2, 38)), Vector(tile_size, tile_size * 19)))
    #w9
    l.append(mapwalls(Vector(tile_size * random.randint(2,25), tile_size * random.randint(2, 38)), Vector(tile_size * 1, tile_size * 2)))
    l.append(mapwalls(Vector(tile_size * random.randint(2,25), tile_size * random.randint(2, 38)), Vector(tile_size * 1, tile_size * 2)))
    #w10
    l.append(mapwalls(Vector(tile_size * random.randint(2,25), tile_size * random.randint(2, 38)), Vector(tile_size, tile_size * 16)))
    #w11
    l.append(mapwalls(Vector(tile_size * random.randint(2,25), tile_size * random.randint(2, 38)), Vector(tile_size * 9, tile_size)))
    l.append(mapwalls(Vector(tile_size * random.randint(2,25), tile_size * random.randint(2, 38)), Vector(tile_size * 4, tile_size)))
    l.append(mapwalls(Vector(tile_size * random.randint(2,25), tile_size * random.randint(2, 38)), Vector(tile_size * 4, tile_size)))
    l.append(mapwalls(Vector(tile_size * random.randint(2,25), tile_size * random.randint(2, 38)), Vector(tile_size, tile_size * 5)))
    l.append(mapwalls(Vector(tile_size * random.randint(2,25), tile_size * random.randint(2, 38)), Vector(tile_size, tile_size * 5)))
    l.append(mapwalls(Vector(tile_size * random.randint(2,25), tile_size * random.randint(2, 38)), Vector(tile_size * 4, tile_size)))
    l.append(mapwalls(Vector(tile_size * random.randint(2,25), tile_size * random.randint(2, 38)), Vector(tile_size * 4, tile_size)))
    l.append(mapwalls(Vector(tile_size * random.randint(2,25), tile_size * random.randint(2, 38)), Vector(tile_size * 4, tile_size)))
    ...
    l.append(mapwalls(Vector(tile_size * random.randint(2,25), tile_size * random.randint(2, 38)), Vector(tile_size * 4, tile_size)))
    #W12
    l.append(mapwalls(Vector(tile_size * random.randint(2,25), tile_size * random.randint(2, 38)), Vector(tile_size * 1, tile_size)))
    l.append(mapwalls(Vector(tile_size * random.randint(2,25), tile_size * random.randint(2, 38)), Vector(tile_size * 1, tile_size)))
    l.append(mapwalls(Vector(tile_size * random.randint(2,25), tile_size * random.randint(2, 38)), Vector(tile_size * 1, tile_size)))
    l.append(mapwalls(Vector(tile_size * random.randint(2,25), tile_size * random.randint(2, 38)), Vector(tile_size * 1, tile_size)))
    l.append(mapwalls(Vector(tile_size * random.randint(2,25), tile_size * random.randint(2, 38)), Vector(tile_size * 1, tile_size)))
